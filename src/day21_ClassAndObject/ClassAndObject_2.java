...
public class ClassAndObject_2 {
	...
	public ClassAndObject_2(String name, String add, String email, long mobile, String proof, long proofId) {
		this.name = name;
		this.add = add;
		this.email = email;
		this.mobile = mobile;
	...
	public static void main(String args[]) {
		...
		ClassAndObject_2 details = new ClassAndObject_2(name, add, email, mobile, proof, proofId);
