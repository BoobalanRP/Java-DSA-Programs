...
abstract class LibraryCardDetail {
	private String name;
	private String card_number;
	private String expiry_date;

	LibraryCardDetail(String name, String card_number, String expiry_date) {
		this.setName(name);
...
class MembershipCard extends LibraryCardDetail {
...
class LifeLongMembershipCard extends LibraryCardDetail {
	private int minimumBookToBorrow;
